//
//AnimationNavigationViewController.m
//NavigationBarSwipe
//
...
#import "AnimationNavigationViewController.h"
#import "NavigationAnimationManager.h"
...
@interface AnimationNavigationViewController ()
<
...
@property (nonatomic, strong) NavigationAnimationManager *animationManager;

@end

@implementation AnimationNavigationViewController
...
- (NSArray <UIViewController *> *)popToViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    _animationManager.removeCount = removeCount;
...
- (NSArray <UIViewController *> *)popToRootViewControllerAnimated:(BOOL)animated {
    ...
    [_animationManager removeAllScreenShot];
